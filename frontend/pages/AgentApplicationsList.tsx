 ...
 *
 * Full filterable, searchable list of applications assigned to the signed-in
 * agent. Each row links to the full detail view.
 */
    ...
    <div className="container space-y-6 py-10 animate-fade-in">
      <header className="space-y-1">
        ...
        <p className="text-sm text-muted-foreground">
          All applications assigned to you. Use filters or search to narrow down.
        </p>
      </header>
            ...
            <div className="flex flex-col items-center gap-3 py-16 text-center">
              ...
              {applications.length === 0 && (
                <p className="max-w-xs text-sm text-muted-foreground">
                  Applications will appear here once an admin assigns them to you.
                </p>
              )}
            </div>
          ) : (
